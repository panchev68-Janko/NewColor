...
> [!TIP]
>
> Много по лесно става с използването на семафори и опашки
...
трябва да се предефинират наколко функции на TouchGFX
...
{
    BSP::TFT.writeWindow (reinterpret_cast<const uint16_t *> (src), x, y, w, h);
}
```
